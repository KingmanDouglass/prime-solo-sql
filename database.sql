...
UPDATE "accounts" SET "account_balance"= 10 WHERE "account_balance"= 0 AND WHERE "transactions_attempted"= 0;
...
UPDATE "accounts" SET "city"= 'sante fe' WHERE ("username"= 'anthony' AND "city"= 'chicago');
